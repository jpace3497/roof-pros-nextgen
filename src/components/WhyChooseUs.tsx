  ...
  <section id="why-us" className="py-24 lg:py-32 bg-navy">
    <div className="container mx-auto px-4 lg:px-8">
      <div className="text-center max-w-2xl mx-auto mb-16">
        <span className="text-gold font-semibold text-sm uppercase tracking-widest">Why PeakRoof</span>
        ...
        <p className="text-primary-foreground/60 text-lg">Quality, integrity, and results — the PeakRoof difference.</p>
      </div>
