...
const ServicesSection = ({ lead }: ServicesSectionProps) => {
  const cityLabel = lead.city ? ` in ${lead.city}` : "";
    ...
    <section id="services" className="py-24 lg:py-32 bg-surface">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl lg:text-5xl font-heading font-extrabold text-foreground mt-3 mb-4">Our Roofing Services{cityLabel}</h2>
